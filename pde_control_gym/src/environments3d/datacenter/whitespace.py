...
Eq. 12 exhaust, and the Eq. 10 tile body force. `tile_flows` (Han's coupling
variable, normally the converged `PlenumResult.Q_m3s` from `plenum.run_plenum`)
is a fixed input, so this module only has to build the case and march it to
steady state.
"""
